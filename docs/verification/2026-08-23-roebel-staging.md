...
1. Merge operations #4, Röbel #47/#48, and Stadtstack #35 through #42 plus the
   reviewed control-preflight slice only at their reviewed exact heads and in
   dependency order. Protected-main exceptions must be bounded and branch
   protection restored even on failure.
